 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Mstoreapp Mobile App
 * Plugin URI:        http://mstoreapp.com
 * Description:       Mstoreapp Mobile App plugin for Mobile App API.
 * Version:           8.0.1
 * Author:            Mstoreapp
 * Author URI:        http://mstoreapp.com
 * License:           GPL-2.0+
 * License URI:       http://www.gnu.org/licenses/gpl-2.0.txt
 * Text Domain:       mstoreapp-mobile-app
...
header("Access-Control-Allow-Origin: http://localhost:8200");
